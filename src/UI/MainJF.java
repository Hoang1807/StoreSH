...
import UI.Children.BanHangPanel;
import UI.Children.KeHangPanel;
import UI.Children.KhachHangPanel;
import UI.Children.KhuyenMaiPanel;
import UI.Children.NhapKhoPanel;
import UI.Children.PanelNhanvien;
import UI.Children.PanelTrangchu;
import UI.Children.SanPhamPanel;
import UI.Children.ThietLapPanel;
import Utils.Auth;
import Utils.MsgBox;
...
public class MainJF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/bill.png"))); // NOI18N
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        panelND.remove(0);
        panelND.setLayout(cardLayOut);
        panelND.add(new KhachHangPanel());
        cardLayOut.first(panelND);
