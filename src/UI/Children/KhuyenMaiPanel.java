...
public class KhuyenMaiPanel extends javax.swing.JPanel {
    ...
    public void setFormHD(GGHoaDon ggHD) {
        ...
        if (ggHD.getHoaDonAD() == null) {
            ...
            txtApDungHD.setText(String.valueOf(ggHD.getHoaDonAD()));
        }

        if (ggHD.getMucGG() == null) {
            txtGiaTriHD.setText("");
        } else {
            txtGiaTriHD.setText(String.valueOf(ggHD.getMucGG()));
        }
    ...
    public void setFormGGSP(GGSanPham ggSP) {
        ...
        txtGiaTri.setText(DDTienTe.FormatVND(ggSP.getGiaGiam()));
    ...
    private void initComponents() {
        ...
        btnThemHD = new javax.swing.JLabel();
        btnSuaHD = new javax.swing.JLabel();
        btnMoiHD = new javax.swing.JLabel();
        ...
        btnThemHD.setBackground(new java.awt.Color(0, 102, 102));
        btnThemHD.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnThemHD.setForeground(new java.awt.Color(255, 255, 255));
        btnThemHD.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        btnSuaHD.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnSuaHD.setText("Sửa");
        btnSuaHD.setOpaque(true);
        btnSuaHD.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnSuaHDMousePressed(evt);
            }
        });
        ...
        btnMoiHD.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnMoiHD.setText("Mới");
        btnMoiHD.setOpaque(true);
        btnMoiHD.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btnMoiHDMousePressed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel9, javax.swing.GroupLayout.PREFERRED_SIZE, 1278, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(34, 34, 34))
        );
        ...
        if (tblDSKMSanPham.getColumnModel().getColumnCount() > 0) {
            tblDSKMSanPham.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtNgayBD, javax.swing.GroupLayout.DEFAULT_SIZE, 202, Short.MAX_VALUE)
    ...
    private void btnSuaHDMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSuaHDMousePressed
        update();
    }//GEN-LAST:event_btnSuaHDMousePressed

    private void btnMoiHDMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMoiHDMousePressed
        clearFormHD();

    }//GEN-LAST:event_btnMoiHDMousePressed
    ...
    private javax.swing.JLabel btnMoiHD;
    private javax.swing.JButton btnMoiSP;
    private javax.swing.JLabel btnSuaHD;
    private javax.swing.JButton btnSuaSP;
    private javax.swing.JLabel btnThemHD;
