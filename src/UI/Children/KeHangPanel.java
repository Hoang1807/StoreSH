...
import static UI.Children.SanPhamPanel.tblListSP;
import UI.MainJF;
...
public class KeHangPanel extends javax.swing.JPanel {
    ...
    public static void fillTable() {
        ...
        if (listSP != null) {
            ...
            for (int i = 0; i < listSP.size(); i++) {
                ...
                if (sp == null) {
                    Object row[] = {listSP.get(i).getMaSP(), null, listSP.get(i).getTenSP(), listSP.get(i).getSlTrenKe(), listSP.get(i).getDonVi(),DDTienTe.FormatVND( listSP.get(i).getGiaBan()), lh.getTenLoai(), listSP.get(i).getQrCode()};
                    model.addRow(row);
                } else {
                    Object row[] = {listSP.get(i).getMaSP(), null, listSP.get(i).getTenSP(), listSP.get(i).getSlTrenKe(), listSP.get(i).getDonVi(), "<HTML><strike>"+DDTienTe.FormatVND( + listSP.get(i).getGiaBan()) + "</strike>" + " - " + DDTienTe.FormatVND(listSP.get(i).getGiaGiam()), lh.getTenLoai(), listSP.get(i).getQrCode()};
                    model.addRow(row);
                }

            }
            tblSanTrenKe.getColumnModel().getColumn(1).setCellRenderer(new CellRenderer(bfimage));
        }

    }

    public void soMatHangTrenKe() {
    ...
    ///tab3
    public void fillLichSuPX(String ngayBD, String ngayKT, String theoNgay) {
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addComponent(btnNhapSPLenKe, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private javax.swing.JLabel lblSLSapHet;
    private javax.swing.JLabel lblSoMatHang;
    private HELP.Table tblCTPX;
    private HELP.Table tblLichSu;
    private javax.swing.JTable tblSPSapHet;
