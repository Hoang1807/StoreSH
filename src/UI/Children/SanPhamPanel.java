    ...
    public static void fillTable() {
        ...
        if (listSP != null) {
            ...
            for (int i = 0; i < listSP.size(); i++) {
                ...
                Object row[] = {listSP.get(i).getMaSP(), null, listSP.get(i).getTenSP(), listSP.get(i).getSLTonKho(), listSP.get(i).getSlTrenKe(), listSP.get(i).getGiaBan() + " VND", listSP.get(i).getGiaNhap() + " VND", listSP.get(i).getMaLoai(), listSP.get(i).getDonVi(), listSP.get(i).getQrCode(), listSP.get(i).isTrangThai() ? "Đang kinh doanh" : "Ngừng kinh doanh"};
                model.addRow(row);
            }
            tblListSP.getColumnModel().getColumn(1).setCellRenderer(new CellRenderer(bfimage));
...
//        this.jButton2 = jButton2;
    ...
    private void initComponents() {
        ...
        cboLocSP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboLocSPActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabpanel, javax.swing.GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//                        MainJF.ListSanPham = spDAO.selectAll();
    ...
    private void cboLocSPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboLocSPActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboLocSPActionPerformed
